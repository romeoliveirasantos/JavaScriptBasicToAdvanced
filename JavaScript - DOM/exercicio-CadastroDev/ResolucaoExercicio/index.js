...
addTechBtn.addEventListener('click', function(ev){
  ...
  const expRadio3 = createInput('expRadio-' + rowIndex + '.1', '5+ anos', 'techExp-' + rowIndex, 'radio');
...
form.addEventListener('submit', function(ev){
  ...
  const fullnameIput = document.getElementById('fullname');
